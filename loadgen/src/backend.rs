...
use crate::fakeconn::FakeConnection;
...
impl Backend {
    ...
    pub fn create_fake_connection(&self, max_packets: usize) -> io::Result<Connection> {
        Ok(match *self {
            Backend::Runtime => Connection::RuntimeFake(FakeConnection::new(max_packets)),
            _ => panic!("custom connection is unsupported by the linux backend"),
        })
    }
...
impl Connection {
    ...
    pub fn local_addr(&self) -> SocketAddrV4 {
        match *self {
            ...
            Connection::RuntimeFake(ref s) => s.local_addr(),
        }
    }
    ...
    pub fn shutdown(&self) {
        match *self {
            ...
            Connection::RuntimeFake(ref s) => s.shutdown(),
        }
    }
}
...
impl Read for Connection {
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
        match *self {
            ...
            Connection::RuntimeFake(ref mut s) => s.read(buf),
        }
    }
}
...
impl<'a> Read for &'a Connection {
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
        match *self {
            ...
            Connection::RuntimeFake(ref s) => (&*s).read(buf),
        }
    }
}
...
impl<'a> Write for &'a Connection {
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
        match *self {
            ...
            Connection::RuntimeFake(ref s) => (&*s).write(buf),
        }
    }
    ...
    fn flush(&mut self) -> io::Result<()> {
        match *self {
            ...
            Connection::RuntimeFake(ref s) => (&*s).flush(),
        }
    }
}
...
impl Write for Connection {
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
        match *self {
            ...
            Connection::RuntimeFake(ref mut s) => s.write(buf),
        }
    }
    ...
    fn flush(&mut self) -> io::Result<()> {
        match *self {
            ...
            Connection::RuntimeFake(ref mut s) => s.flush(),
        }
    }
}
