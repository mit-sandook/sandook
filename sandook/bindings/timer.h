...
extern "C" void TimerTrampoline(unsigned long arg);  // NOLINT
...
class Timer : private timer_internal::timer_node {
 public:  // NOLINTBEGIN
  explicit Timer(Callable &&func) noexcept
    ...
    auto arg = reinterpret_cast<unsigned long>(
        static_cast<timer_node *>(this));  // NOLINTEND
